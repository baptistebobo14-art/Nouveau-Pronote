...
group.forEach(course => {
    ...
    if(laneCount === 1){
        course._displayMode = "full";
    }
    else if(laneCount === 2){
        course._displayMode = "normal";
    }
    else if(laneCount === 3){
        course._displayMode = "compact";
    }
    else if(laneCount === 4){
        course._displayMode = "very-compact";
    }
    else if(laneCount <= 6){
        course._displayMode = "ultra-compact";
    }
    else{
        course._displayMode = "minimal";
    }
...
title="${course.subject} • ${course.teacher || "Prof non renseigné"} • ${course.room || "Salle non renseignée"} • ${course.className || "Classe non renseignée"}"
...
${
    course._laneCount <= 6 && course.teacher
        ? `
...
${
    course._laneCount <= 4 && course.room
        ? `
...
${
    course._laneCount <= 2 && course.className
        ? `
