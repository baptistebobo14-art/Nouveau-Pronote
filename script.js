...
const selectedStudentFilter = document.getElementById("notesStudentFilter")?.value;
const selectedTrimesterFilter = document.getElementById("notesTrimesterFilter")?.value;

await loadNotes();

showPage("notes");

if (selectedStudentFilter !== undefined) {
    const studentFilter = document.getElementById("notesStudentFilter");
    if (studentFilter) {
        studentFilter.value = selectedStudentFilter;
    }
}

if (selectedTrimesterFilter !== undefined) {
    const trimesterFilter = document.getElementById("notesTrimesterFilter");
    if (trimesterFilter) {
